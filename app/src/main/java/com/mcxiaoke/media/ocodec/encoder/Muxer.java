...
public class Muxer {
    ...
    private Encoder mVideoEncoder, mAudioEncoder;
     ...
     * @throws IOException
     */
    public Muxer(final Config config) throws IOException {
        try {
            mOutputPath = getCaptureFile(Environment.DIRECTORY_MOVIES, Config.FILE_MP4).toString();
...
//**********************************************************************
     ...
     */
    /*package*/ void addEncoder(final Encoder encoder) {
